...
// NOTE: We use explicit exports to exclude internal testing utilities (_resetGuardCounter)
// Users needing internal utilities should import directly from @veloxts/auth
export {
  // Types
