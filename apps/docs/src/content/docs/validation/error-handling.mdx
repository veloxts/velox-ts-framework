...
Velox TS provides structured validation error responses that work seamlessly across backend and frontend.

## Error Response Structure

When `.input()` validation fails, Velox TS returns a structured error:
