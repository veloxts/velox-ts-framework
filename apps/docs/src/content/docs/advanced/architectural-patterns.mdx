...
### Pattern 3: Domain Modules (Enterprise)
...
For the full module API, manual patterns, encapsulation, security layers, and inter-module communication, see **[Domain Modules](/docs/endpoints/domain-modules/)**.
...
- [Domain Modules](/docs/endpoints/domain-modules/) - Vertical domain slices with services and lifecycle
