...
Rate limiting restricts how many attempts a client can make within a time window, with progressive backoff that increases delays after repeated failures.
