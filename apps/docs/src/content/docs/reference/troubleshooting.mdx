...
description: Solutions to common Velox TS issues.
---

If you're hitting an error during development, chances are someone else has seen it too. This page collects the most common issues — Prisma 7 migration gotchas, TypeScript configuration problems, build errors, and runtime exceptions — with copy-paste solutions.
