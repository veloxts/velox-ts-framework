---
title: Application
description: The Velox TS application instance and lifecycle.
---
...
<Aside type="caution">
Prefer Velox TS abstractions when possible. Direct Fastify access bypasses type-safe procedure patterns.
</Aside>
