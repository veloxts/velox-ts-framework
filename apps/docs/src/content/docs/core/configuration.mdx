---
title: Configuration
description: Configure your Velox TS application.
---

Most applications need different settings for development, testing, and production — database URLs, log levels, timeouts, secrets. Velox TS handles this through environment variables and configuration objects, with optional environment-aware presets that eliminate boilerplate.
