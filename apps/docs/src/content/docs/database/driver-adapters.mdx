...
<Aside type="note">
Prisma 7 supports additional adapters (MySQL, LibSQL/Turso). Velox TS templates currently ship with SQLite and PostgreSQL—LibSQL/Turso support for edge deployments is [on the roadmap](https://github.com/veloxts/velox-ts-framework/blob/main/.plans/ROADMAP.md) for v1.1.
</Aside>
...
// Velox TS handles this automatically via the ORM plugin
// For manual setups:
