...
description: Configure Prisma 7 with driver adapters for Velox TS applications.
---

import { Aside, Tabs, TabItem, Steps } from '@astrojs/starlight/components';

Velox TS uses Prisma 7, which introduces significant architectural changes from previous versions.

<Aside type="caution" title="Breaking Changes in Prisma 7">
Prisma 7 removes `datasourceUrl` from PrismaClient and requires driver adapters. All Velox TS templates are pre-configured—this guide is for understanding or migrating existing projects.
</Aside>
