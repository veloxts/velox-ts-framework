...
<Aside type="note">
This section covers RSC templates (`--rsc`, `--rsc-auth`). For SPA templates that consume VeloxTS APIs from a separate frontend, see [Client Package](/docs/client/overview/).
</Aside>
