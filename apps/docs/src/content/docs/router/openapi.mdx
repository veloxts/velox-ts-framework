...
External API consumers need documentation they can explore and test against. Velox TS generates a complete OpenAPI 3.0.3 specification from your procedure definitions — including input/output schemas, HTTP methods, and Zod field descriptions — and serves interactive Swagger UI alongside your API.
