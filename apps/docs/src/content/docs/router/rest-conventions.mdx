...
Velox TS supports nested resources for modeling hierarchical relationships. See the [Nested Routes](/docs/router/nested-routes/) guide for full documentation.
...
For `get*`, `update*`, `edit*`, `patch*`, `delete*`, and `remove*` prefixes, Velox TS:
