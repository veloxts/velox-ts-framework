...
**VeloxTS Framework** is a TypeScript full-stack web framework (v0.7.x) providing exceptional developer experience and type safety. Built on Fastify, tRPC, Prisma, and Zod. Targets Node.js v20+ with TypeScript v5+.
